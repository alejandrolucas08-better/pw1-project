...
export const Register: React.FC = () => {
  ...
  // Limpadores de feedback ao digitar
      ...
      <Row className="w-100 justify-content-center">
        <Col xs={11} sm={8} md={5} lg={4} xl={3}>
          ...
          <div className="text-center mb-5">
            ...
            <p className="text-white-50 small">Preencha os campos para iniciar sua carteira</p>
          </div>
          ...
          <div className="text-center mt-4">
            <span className="text-white-50 small">Já possui login? </span>
